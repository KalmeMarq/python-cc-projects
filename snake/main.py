...
def render(screen):
    ...
    if game_state == GameState.PLAYING:
        ...
        screen.blit(start_text,
                    (GAME_WIDTH / 2 - start_text.get_width() / 2, GAME_HEIGHT / 2 - start_text.get_height() / 2))
    elif game_state == GameState.LOST:
        screen.blit(lost_text,
                    (GAME_WIDTH / 2 - lost_text.get_width() / 2, GAME_HEIGHT / 2 - lost_text.get_height() / 2 - 80))
        screen.blit(start_text,
                    (GAME_WIDTH / 2 - start_text.get_width() / 2, GAME_HEIGHT / 2 - start_text.get_height() / 2))
    elif game_state == GameState.WON:
        screen.blit(won_text,
                    (GAME_WIDTH / 2 - lost_text.get_width() / 2, GAME_HEIGHT / 2 - lost_text.get_height() / 2 - 80))
        screen.blit(start_text,
                    (GAME_WIDTH / 2 - start_text.get_width() / 2, GAME_HEIGHT / 2 - start_text.get_height() / 2))
